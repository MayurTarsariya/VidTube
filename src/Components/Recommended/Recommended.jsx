...
export const Recommended = ({ categoryId, isDark }) => {
    const [apiData, setApiData] = useState([]);
    const fetchReletedVideos = async () => {
        const reletedVideoUrl = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=100&regionCode=IN&videoCategoryId=${categoryId}&key=${API_KEY}`;
    ...
    return (
        <div className={isDark ? 'recommended recdark' : 'recommended'}>
